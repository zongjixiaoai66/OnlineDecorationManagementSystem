    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">在线装修管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="团队名称" class="input" v-if="tableName=='tuandui'">
                            <el-input v-model="ruleForm.tuanduiName" autocomplete="off" placeholder="团队名称"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='tuandui'">
                            <el-input v-model="ruleForm.tuanduiPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='tuandui'">
                            <el-input v-model="ruleForm.tuanduiEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.tuanduiName)&& 'tuandui'==this.tableName){
                                this.$message.error('团队名称不能为空');
                                return
                            }
                             if('tuandui' == this.tableName && this.ruleForm.tuanduiPhone&&(!this.$validate.isMobile(this.ruleForm.tuanduiPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('tuandui' == this.tableName && this.ruleForm.tuanduiEmail&&(!this.$validate.isEmail(this.ruleForm.tuanduiEmail))){
