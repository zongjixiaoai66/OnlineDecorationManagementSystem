...
|| (sessionTable == 'tuandui' && scope.row.tuanduiId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zaixianzhuangxiuguanli/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.tuanduiId = el.tuanduiId;//---
                            forum.tuanduiName = el.tuanduiName;
                            forum.tuanduiPhoto = el.tuanduiPhoto;
                            forum.tuanduiPhone = el.tuanduiPhone;
                            forum.tuanduiEmail = el.tuanduiEmail;
                            forum.tuanduiContent = el.tuanduiContent;
                            forum.tuanduiDelete = el.tuanduiDelete;
                            forum.createTime = el.createTime;
