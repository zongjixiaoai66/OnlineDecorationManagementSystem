<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='tuandui'"  label='团队名称' prop="tuanduiName">
               <el-input v-model="ruleForm.tuanduiName"  placeholder='团队名称' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='tuandui'" label='团队头像' prop="tuanduiPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='tuandui'"  label='联系方式' prop="tuanduiPhone">
               <el-input v-model="ruleForm.tuanduiPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='tuandui'"  label='电子邮箱' prop="tuanduiEmail">
               <el-input v-model="ruleForm.tuanduiEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='tuandui'"  label="团队介绍" prop="tuanduiContent">
                 <editor
...
// 注册表 装修队 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.tuanduiName)&& 'tuandui'==this.flag){
                             this.$message.error('团队名称不能为空');
                             return
                         }

                         if((!this.ruleForm.tuanduiPhoto)&& 'tuandui'==this.flag){
                             this.$message.error('团队头像不能为空');
                             return
                         }

                         if((!this.ruleForm.tuanduiPhone)&& 'tuandui'==this.flag){
                             this.$message.error('联系方式不能为空');
                             return
                         }

                             if( 'tuandui' ==this.flag && this.ruleForm.tuanduiEmail&&(!isEmail(this.ruleForm.tuanduiEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
                         if((!this.ruleForm.tuanduiContent)&& 'tuandui'==this.flag){
