...
var centerMenu = [
    ...
    ,{
        name: '装修收藏',
        url: '../zhuangxiuCollection/list.html'
    }
    ,{
        name: '装修订单',
        url: '../zhuangxiuOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '装修',
        url: './pages/zhuangxiu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/zaixianzhuangxiuguanli/admin/dist/index.html#/login";
