...
public class ZhuangxiuCollectionView extends ZhuangxiuCollectionEntity implements Serializable {
	...
	*/
	...
	private String zhuangxiuCollectionValue;
	...
	public ZhuangxiuCollectionView() {

	}

	public ZhuangxiuCollectionView(ZhuangxiuCollectionEntity zhuangxiuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zhuangxiuCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getZhuangxiuCollectionValue() {
		return zhuangxiuCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setZhuangxiuCollectionValue(String zhuangxiuCollectionValue) {
		this.zhuangxiuCollectionValue = zhuangxiuCollectionValue;
	}
	...
	public String toString() {
		return "ZhuangxiuCollectionView{" +
			", zhuangxiuCollectionValue=" + zhuangxiuCollectionValue +
