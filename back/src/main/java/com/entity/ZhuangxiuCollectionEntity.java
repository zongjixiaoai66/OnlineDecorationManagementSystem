...
public class ZhuangxiuCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhuangxiuCollectionEntity() {

	}

	public ZhuangxiuCollectionEntity(T t) {
		try {
    ...
    @TableField(value = "zhuangxiu_collection_types")
    ...
    public String toString() {
        return "ZhuangxiuCollection{" +
            ", id=" + id +
            ", zhuangxiuId=" + zhuangxiuId +
            ", yonghuId=" + yonghuId +
            ", zhuangxiuCollectionTypes=" + zhuangxiuCollectionTypes +
