...
public class ZhuangxiuOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhuangxiuOrderEntity() {

	}

	public ZhuangxiuOrderEntity(T t) {
		try {
     ...
     * 装修
     */
    @ColumnInfo(comment="装修",type="int(11)")
    ...
    public String toString() {
        return "ZhuangxiuOrder{" +
            ", id=" + id +
            ", zhuangxiuOrderUuidNumber=" + zhuangxiuOrderUuidNumber +
            ", zhuangxiuId=" + zhuangxiuId +
            ", yonghuId=" + yonghuId +
            ", zhuangxiuOrderTime=" + DateUtil.convertString(zhuangxiuOrderTime,"yyyy-MM-dd") +
            ", zhuangxiuOrderTruePrice=" + zhuangxiuOrderTruePrice +
            ", zhuangxiuOrderTypes=" + zhuangxiuOrderTypes +
            ", zhuangxiuOrderPaymentTypes=" + zhuangxiuOrderPaymentTypes +
